...
`,V=e=>{const{text:t}=e;return r.jsx(D,{children:r.jsx("span",{children:t})})};let T;const S="container_message";function _(){let e=document.querySelector(S);return e||(e=document.createElement("div"),e.id=S,x({position:"fixed",top:"10px",left:"50%",transform:"translate(-50%, 0)",zIndex:"9999"},e),document.body.appendChild(e)),e}const U=()=>{const[e,t]=c.useState([]),n=3e3,o=i=>t(s=>s.filter(d=>i.key!==d.key));return T=i=>{t(s=>[...s,i]),setTimeout(()=>{o(i)},n)},r.jsx(r.Fragment,{children:e.map(i=>f.createElement(V,{...i,key:i.key}))})},X=(()=>(E.createRoot(_()).render(r.jsx(U,{})),{info:(t=>n=>T({text:n,type:t,key:R(3)}))("info")}))(),y=c.forwardRef(function(t,n){const{children:o,sx:i,...s}=t;return M.createPortal(r.jsx(G,{...s,css:m(i),ref:n,children:o}),document.body)}),G=h.div(),J=h.div`
  ...
  bottom: 0;
  z-index: 100;
`;let g=null;function K(){return document.body.scrollHeight>(window.innerHeight||document.documentElement.clientHeight)}function Q(){if(K()||(g=0),typeof g=="number")return g;const e=document.createElement("div");x({width:"100%",height:"200px"},e);const t=document.createElement("div");x({position:"absolute",top:"0",left:"0",pointerEvents:"none",visibility:"hidden",width:"200px",height:"150px",overflow:"hidden"},t),t.appendChild(e),document.body.appendChild(t);const n=e.offsetWidth;x({overflow:"scroll"},t);let o=e.offsetWidth;return n===o&&(o=t.clientWidth),document.body.removeChild(t),g=n-o,g}const b=e=>{const[t,n]=c.useState(null),o=c.useCallback(()=>{n(e.current.getBoundingClientRect())},[]);return c.useLayoutEffect(()=>{e.current&&o()},[]),t},k=({triggerRect:e,contentRect:t})=>{const[n,o]=c.useState({transform:""});return c.useEffect(()=>{if(!t||!e)return;const{left:i,width:s,top:d,height:a}=t,{width:u}=e,{margin:p,padding:v}=z(),C=i-(parseInt(p.left)+parseInt(v.left))+(s>>1)-(u>>1),ie=d+a,se=C,ce=ie;o(()=>({transform:`translate(${se}px,${ce}px)`}))},[t,e]),n},Z=e=>{c.useEffect(()=>{const t=Q(),n=document.body.style;return e&&(n.overflow="hidden",n.paddingRight=`${t}px`),()=>{n.overflow="",n.paddingRight=""}},[e])},$=c.forwardRef(function(t,n){const{visible:o=!0,children:i,closeModal:s,sx:d,...a}=t,u=p=>{p.stopPropagation(),p.target===p.currentTarget&&s()};return Z(o),r.jsx(r.Fragment,{children:o&&r.jsx(y,{children:r.jsx(J,{onClick:u,...a,css:m(d),ref:n,children:i})})})});function ee(e){const{defaultOpen:t,children:n,content:o,sx:i,...s}=e,[d,a]=c.useState(t),u=c.useRef(null);return r.jsxs(r.Fragment,{children:[c.cloneElement(n,{onClick:()=>a(p=>!p),ref:u}),d&&r.jsx(y,{sx:{position:"fixed",left:"0",top:"0"},children:r.jsx(te,{anchorRef:u,onClose:()=>{a(p=>!p)},css:m(i),...s,children:o})})]})}const te=e=>{const{children:t,anchorRef:n,onClose:o}=e,i=c.useRef(null),s=b(n),d=b(i);c.useEffect(()=>{const u=[n.current,i.current],p=v=>{const C=v.target;!u.includes(C)&&o()};return window.addEventListener("click",p),()=>window.removeEventListener("click",p)},[]);const a=k({triggerRect:d,contentRect:s});return r.jsx("div",{style:{visibility:a.transform?"visible":"hidden",...a,display:"inline-block",position:"absolute"},children:c.cloneElement(t,{ref:i})})};function ne(e){const{children:t,title:n,sx:o,...i}=e,[s,d]=c.useState(!1),a=c.useRef(null);return r.jsxs(r.Fragment,{children:[c.cloneElement(t,{onMouseEnter:d.bind(null,!0),onMouseLeave:d.bind(null,!1),ref:a,...i}),s&&r.jsx(y,{sx:{position:"fixed",left:"0",top:"0"},children:r.jsx(oe,{childrenRef:a,title:n,sx:o})})]})}const oe=e=>{const{childrenRef:t,title:n,sx:o,...i}=e,s=c.useRef(null),d=b(s),a=b(t),u=k({triggerRect:d,contentRect:a});return r.jsx(r.Fragment,{children:r.jsx(re,{ref:s,style:{...u,visibility:u.transform?"visible":"hidden"},...i,css:m(o),children:n})})},re=h("p")`
